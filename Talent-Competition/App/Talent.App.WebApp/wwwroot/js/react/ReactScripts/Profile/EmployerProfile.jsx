...
export default class EmployeeProfile extends React.Component {
    ...
    saveData(employerData) {
        this.setState({ buttonDisabled: true })
        // TalentUtil.notification.show("Saving employer details", "success", null, null);
        var cookies = Cookies.get('talentAuthToken');
        $.ajax({
            ...
            contentType: "application/json",
            dataType: "json",
            data: JSON.stringify(employerData),
            success: function (res) {
                if (res.success) {
                                    ...
                                    <div className="ui grid">
                                        ...
                                        <div className="sixteen wide column">
                                            <div>
                                                ...
                                                <input type="button" className="ui teal button right floated" disabled={this.state.buttonDisabled} onClick={() => { this.saveData(this.state.employerData) }} value="Save"></input>
                                            </div>
                                        </div >
                                    </div>
                                </form>
