...
export class IndividualDetailSection extends Component {
    ...
    handleChange(event) {
        ...
        const isValid = this.props.validateHandle(event)

        if (!isValid && !this.state.formErrors.includes(name)) {
            const formErrors = [...this.state.formErrors]
            formErrors.push(name)
            this.setState({
                formErrors: [...formErrors]
            })
        } else if (isValid && this.state.formErrors.includes(name)) {
            const formErrors = [...this.state.formErrors]
            formErrors.splice(formErrors.indexOf(name), 1)
            this.setState({
                formErrors: [...formErrors]
            })
        }
        ...
        return (
            <div className='ui sixteen wide column'>
                <ChildSingleInput
                    ...
                    isError={this.state.formErrors.includes("firstName")}
                ...
                <ChildSingleInput
                    ...
                    isError={this.state.formErrors.includes("lastName")}
                ...
                <ChildSingleInput
                    ...
                    isError={this.state.formErrors.includes("email")}
                ...
                <ChildSingleInput
                    ...
                    isError={this.state.formErrors.includes("phone")}
        ...
        return (
            <div className='ui sixteen wide column'>
                <ChildSingleInput
                    ...
                    maxLength={80}
                    placeholder="Enter your last name"
                    isError={this.state.formErrors.includes("name")}
